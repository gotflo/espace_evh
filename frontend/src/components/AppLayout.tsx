    ...
    <div className="app">
      ...
      <aside className={`sidebar ${menuOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav" onClick={() => setMenuOpen(false)}>
          <NavLink to="/tableau-de-bord" className="nav-item"><Icon path={ICONS.dashboard} /><span>Tableau de bord</span></NavLink>
          ...
          {canManageOrg && (
            <NavLink to="/admin/organisation" className="nav-item"><Icon path={ICONS.org} /><span>Organisation</span></NavLink>
          )}
          <NavLink to="/contact" className="nav-item"><Icon path={ICONS.requests} /><span>Nous contacter</span></NavLink>
          <NavLink to="/mon-profil" className="nav-item"><Icon path={ICONS.profile} /><span>Mon profil</span></NavLink>
        </nav>
